...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmStatistics : Form
    {
        ...
        private void FrmStatistics_Load(object sender, EventArgs e)
        {
            ...
            lblAvgCapacity.Text = db.Location.Average(x => x.Capacity)?.ToString("F2")??"0.00";
            ...
            var guideIdByNameAysegülCinar = db.Guide.Where(x => x.GuideName == "Ayşegül" && x.GuideSurname == "Çınar").Select
