...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmLocation : Form
    {
        ...
        private void FrmLocation_Load(object sender, EventArgs e)
        {
            ...
            cnbGuide.DisplayMember = "FullName";
            cnbGuide.ValueMember = "GuideId";
            cnbGuide.DataSource = values;
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            location.GuideId = int.Parse(cnbGuide.SelectedValue.ToString());
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            updateValue.GuideId = int.Parse(cnbGuide.SelectedValue.ToString());
            db.SaveChanges();
